(function(exports,metro,patcher,plugin,assets,toasts,storage,components){'use strict';function emoji(text) {
...
function chatThing() {
  return patcher.before("sendMessage", Messages, function(args) {
    ...
    if ((plugin.storage === null || plugin.storage === void 0 ? void 0 : plugin.storage.type) && ENM[plugin.storage === null || plugin.storage === void 0 ? void 0 : plugin.storage.type]) {
      args[1].content = ENM[plugin.storage.type](args[1].content);
    }
  });
}var _findByProps;
...
function settingPage() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(ScrollView, null, /* @__PURE__ */ React.createElement(FormSection, {
    ...
    onPress: openMT,
    trailing: /* @__PURE__ */ React.createElement(TouchableOpacity, {
      onPress: openMT
    }, /* @__PURE__ */ React.createElement(FormIcon, {
      style: {
        opacity: 1
      },
...
};exports.default=index;Object.defineProperty(exports,'__esModule',{value:true});return exports;})({},vendetta.metro,vendetta.patcher,vendetta.plugin,vendetta.ui.assets,vendetta.ui.toasts,vendetta.storage,vendetta.ui.components);